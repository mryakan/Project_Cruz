...
# ====================
# - <2016-Nov-07> by "Medhat R.Yakan": Adding docstrings + some refactoring
#
#
...
def download_and_extract_dataset():
    ...
    Next, extract the dataset from the compressed .tar.gz file.
    ...
    num_classes = 10
    np.random.seed(133) # pylint: disable=E1101
